...
public class Janken extends JFrame {
  ...
  ImageIcon[] icons = {
	  new ImageIcon(getClass().getResource("../../img/img/gu.png")),
      new ImageIcon(getClass().getResource("../../img/img/choki.png")),
      new ImageIcon(getClass().getResource("../../img/img/pa.png"))
    };
